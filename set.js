...
module.exports = {
SESSION_ID: process.env.SESSION_ID || "PRINCE-MDX~vozsRHk4flAGNQsopeVS", // Add sess Id here espwcially when deploying on panels else use app.json and .env file...
SUDO_NUMBERS: process.env.SUDO_NUMBERS || "918637500727", //Add multiple Numbers with Country Codes without (+) Separated by Comma...
